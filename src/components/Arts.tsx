...
const exhibitionsSchema: FieldSchema[] = [
              ...
              <div className="flex-grow p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col min-h-0">
                <div className="flex-1 min-h-0 overflow-y-auto pr-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {(Array.isArray(selectedWork.tags) ? selectedWork.tags : ((selectedWork.tags as unknown as string) || '').split(',')).map((tag: any, i: number) => (
